...
class ExpectationValidationResult(SerializableDictDot):
    ...
    def to_json_dict(self) -> dict[str, JSONValues]:
        ...
        Returns:
            Dictionary – A JSON-serializable dict representation of this ExpectationValidationResult.
        """
...
class ExpectationSuiteValidationResult(SerializableDictDot):
    ...
    def to_json_dict(self):
        ...
        Returns:
            Dictionary – A JSON-serializable dict representation of this ExpectationSuiteValidationResult.
        """
