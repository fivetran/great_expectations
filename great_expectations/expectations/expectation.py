...
class Expectation(pydantic.BaseModel, metaclass=MetaExpectation):
    ...
    def _get_result_format(
        ...
        # defaulting to empty dict to avoid type errors is safe. All uses expect a string or a dict and if a dict is
        # provided, it is parsed correctly with defaults injected.
        # TODO: when working in the area, result format should be typed and defaults should be injected here, rather
        # than other parts of the codebase.
