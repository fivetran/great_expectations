...
class ExpectColumnSumToBeBetween(ColumnAggregateExpectation):
    ...
    strict_min: Union[bool, SuiteParameterDict] = pydantic.Field(default=False, description=STRICT_MIN_DESCRIPTION)
    strict_max: Union[bool, SuiteParameterDict] = pydantic.Field(default=False, description=STRICT_MAX_DESCRIPTION)
