...
class ExpectColumnValuesToMatchStrftimeFormat(ColumnMapExpectation):
    ...
    This Expectation supports Pandas and Spark Data Sources. It does not currently support SQL Data Sources because Python strftime format tokens do not map consistently to SQL dialect date parsing functions.
    ...
    Example Data:
                event_date                   logged_at
            0   "2026-01-15"                "2026-01-15T10:30:00+0000"
            1   "2026-06-20"                "2026-06-20T14:45:00+0000"
            2   "not a date"                "2026-12-31T23:59:59+0000"
    ...
    class Config:
        ...
        def schema_extra(
            schema: Dict[str, Any],
            model: Type[ExpectColumnValuesToMatchStrftimeFormat],
        ) -> None:
