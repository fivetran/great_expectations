...
class PandasDatasource(_PandasDatasource):
    ...
    def add_sql_query_asset(  # FIXME CoP
        self,
        name: str,
        sql: sa.select | sa.text | str,  # type: ignore[valid-type] # FIXME CoP
        con: sqlalchemy.Engine | sqlite3.Connection | str,
    ...
    def add_sql_table_asset(  # FIXME CoP
        self,
        name: str,
        table_name: str,
