...
class SparkFilesystemDatasource(_SparkFilePathDatasource):
    ...
    def add_directory_csv_asset(  # FIXME CoP
        self,
        name: str,
        *,
        batch_metadata: Optional[BatchMetadata] = ...,
    ...
    def add_directory_orc_asset(  # FIXME CoP
        self,
        name: str,
        *,
        batch_metadata: Optional[BatchMetadata] = ...,
    ...
    def add_directory_json_asset(  # FIXME CoP
        self,
        name: str,
        *,
        batch_metadata: Optional[BatchMetadata] = ...,
    ...
    def add_directory_text_asset(  # FIXME CoP
        self,
        name: str,
        *,
        batch_metadata: Optional[BatchMetadata] = ...,
