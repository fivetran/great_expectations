...
class TestDialectRequiresPersistedConnection:
    def test__dialect_requires_persisted_connection_mssql(self):
        connection_string = "mssql+pyodbc://sa:ReallyStrongPwd1234%^&*@db_hostname:1433/test_ci?driver=ODBC Driver 18 for SQL Server&charset=utf8&autocommit=true&TrustServerCertificate=yes"  # noqa: E501 # FIXME CoP
