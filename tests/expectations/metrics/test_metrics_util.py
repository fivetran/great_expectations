...
@pytest.mark.unit
@pytest.mark.parametrize(
    "dialect_name,select_statement_factory,expected_sql,mock_params",
    [
        pytest.param(
            "sqlite",
...
def test_sqlalchemy_select_to_sql_string_parameter_styles(
    ...
    with (
        ...
        mock_compiler.__str__ = lambda self: expected_sql
