...
class TestClickHouseNullable:
    ...
    def test_scalar_mismatch_reports_nested_type(self):
        success, observed = compare_column_type(
            self.engine, _NullableType(sa.types.BIGINT()), "VARCHAR"
        )
    ...
    def test_list_mismatch_reports_nested_type(self):
        success, observed = compare_column_type_list(
            self.engine,
            _NullableType(sa.types.BIGINT()),
            ["VARCHAR", "TEXT"],
    ...
    def test_unwrap_is_clickhouse_only(self):
        engine = _StubEngine("sqlite", dialect_module=sa)
        success, observed = compare_column_type(engine, _NullableType(sa.types.BIGINT()), "BIGINT")
