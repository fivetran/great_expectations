...
def test_expect_column_values_to_be_in_set_atomic_diagnostic_observed_value(
    description,
    value_set,
    observed_value,
    expected_result,
...
def test_expect_column_values_to_not_be_in_set_atomic_diagnostic_observed_value(
    description,
    value_set,
    observed_value,
    expected_result,
