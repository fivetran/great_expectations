...
def test_data_context_ge_cloud_mode_makes_successful_request_to_cloud_api(
    ...
    called_with_url = f"{ge_cloud_runtime_base_url}/api/v1/organizations/{ge_cloud_runtime_organization_id}/workspaces/{ge_cloud_workspace_id}/data-context-configuration"  # noqa: E501 # FIXME CoP
