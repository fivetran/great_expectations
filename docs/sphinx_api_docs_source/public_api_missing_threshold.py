...
ITEMS_IGNORED_FROM_PUBLIC_API = [
    ...
    PrintableDefinition(
        file=pathlib.Path("great_expectations/core/partitioners.py"), name="ColumnPartitionerDaily"
    ),
    PrintableDefinition(
        file=pathlib.Path("great_expectations/core/partitioners.py"), name="FileNamePartitionerDaily"
    ),
    PrintableDefinition(
        file=pathlib.Path("great_expectations/data_context/data_context/abstract_data_context.py"), name="update_datasource"
    ),
    PrintableDefinition(
        file=pathlib.Path("great_expectations/datasource/fluent/sources.py"), name="update_datasource"
    ),
]
