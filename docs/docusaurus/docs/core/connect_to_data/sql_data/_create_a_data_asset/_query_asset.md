A Query Data Asset consists of the records returned by a SQL query. Note that Trino Data Sources do not support Query Data Assets. Creating a A Query Data Asset takes two required parameters:
