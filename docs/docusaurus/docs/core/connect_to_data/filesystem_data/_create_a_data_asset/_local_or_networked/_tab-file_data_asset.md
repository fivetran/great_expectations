...
2. Add the Data Asset to your Data Source.
   ...
   - To see the file formats supported by a pandas File Data Source, reference the `.add_*_asset(...)` methods in the [`PandasFilesystemDatasource` reference page](/reference/api/datasource/fluent/PandasFilesystemDatasource_class.mdx).
   - To see the file formats supported by a Spark File Data Source, reference the `.add_*_asset(...)` methods in the [`SparkFilesystemDatasource` reference page](/reference/api/datasource/fluent/SparkFilesystemDatasource_class.mdx).
