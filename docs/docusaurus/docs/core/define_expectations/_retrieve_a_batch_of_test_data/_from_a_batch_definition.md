...
2. Optional. Specify the Batch to retrieve.
   ...
   Note that the format depends on whether or not you are using a [File Data Asset](/core/connect_to_data/filesystem_data/?data_asset=file#create-a-data-asset) 
