...
![Example of how GX Cloud can detect issues as raw data is imported into a data warehouse. Expectations like 'Expect column values to be unique' and 'Expect column values to not be null' can be used to clean and sanitize data.](/img/integration-ingestion.png)
