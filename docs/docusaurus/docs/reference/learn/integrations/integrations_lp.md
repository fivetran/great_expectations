...
<LinkCardGrid>
  ...
  <LinkCard topIcon label="Integrate GX in a data pipeline" description="Learn how to add data validation to a data pipeline using GX." to="/reference/learn/integrations/data_pipeline_tutorial" icon="/img/airflow_icon.svg"/>
