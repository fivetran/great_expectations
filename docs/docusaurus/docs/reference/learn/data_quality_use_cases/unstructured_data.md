...
This article assumes basic familiarity with GX components and workflows. If you're new to GX, start with the [GX Cloud](/cloud/overview/gx_cloud_overview.md) and [GX Core](docs/core/introduction/introduction.md) overviews to familiarize yourself with key concepts and setup procedures.
