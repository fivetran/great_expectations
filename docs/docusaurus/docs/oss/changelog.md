...
### 1.3.5
* [DOCS] New icons for admonitions ([#10899](GxURL.PULL_REQUESTS/10899))
* [DOCS] Algolia fix ([#10907](GxURL.PULL_REQUESTS/10907))
* [MAINTENANCE] Add `row_condition` datetime testing for Pandas and Spark ([#10892](GxURL.PULL_REQUESTS/10892))
* [MAINTENANCE] Cleanup bigquery every 3 hours ([#10900](GxURL.PULL_REQUESTS/10900))
* [MAINTENANCE] Add `strict` to Window type ([#10906](GxURL.PULL_REQUESTS/10906))
* [MAINTENANCE] ensure run_id on ValidationDefinition.run ([#10909](GxURL.PULL_REQUESTS/10909))
