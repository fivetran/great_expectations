...
### 1.4.5
* [BUGFIX] use existing LRU cache for secrets store ([#11184](https://github.com/great-expectations/great_expectations/pull/11184))
...
* [CONTRIB] (redshift): add GEOMETRY, and SUPER types to REDSHIFT_TYPES ([#11183](https://github.com/great-expectations/great_expectations/pull/11183)) (thanks @VolkovGeoPhy)
