...
### 1.14.0
* [FEATURE] Add `ValidationDefinition.get_unexpected_rows()` to retrieve all failing rows without the 200-row cap ([#11711](https://github.com/great-expectations/great_expectations/pull/11711))
