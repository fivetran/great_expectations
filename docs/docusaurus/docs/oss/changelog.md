...
* [BUGFIX] Fix broken link in issue assign welcome message ([#11961](https://github.com/fivetran/great_expectations/pull/11961)) (thanks Claude Sonnet 5)
* [DOCS] Enumerate Ephemeral Data Context use cases in type overview ([#11931](https://github.com/fivetran/great_expectations/pull/11931)) (thanks Yossi Eliaz)
...
* [MAINTENANCE] Extract type comparison logic into dedicated module ([#11798](https://github.com/fivetran/great_expectations/pull/11798)) (thanks Claude Opus 4.6 (1M context))
