...
|---|---|---|---|
| Data sources | Amazon Aurora<br/>Amazon S3<br/>Azure Blob Storage<br/>BigQuery<br/>CitusDB<br/>Databricks SQL<br/>Google AlloyDB<br/>Google Cloud Storage<br/>NeonDB<br/>Pandas in-memory<br/>PostgreSQL<br/>Redshift<br/>Snowflake<br/>Spark in-memory | Amazon Aurora<br/>Amazon S3<br/>Azure Blob Storage<br/>BigQuery<br/>CitusDB<br/>Databricks SQL<br/>Google AlloyDB<br/>Google Cloud Storage<br/>NeonDB<br/>Pandas in-memory<br/>PostgreSQL<br/>Redshift<br/>Snowflake<br/>Spark in-memory<br/>SQLite | We've seen GX Core work with the following data sources in the past, but don't guarantee ongoing compatibility at this time: Athena, AWS Glue, Clickhouse, Databricks (Spark), Dremio, EMR Spark, Microsoft Fabric, MSSQL, MySQL, Teradata,  Trino,  Vertica. |
