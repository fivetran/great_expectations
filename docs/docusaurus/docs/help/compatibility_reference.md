...
| Alerts | Email<br/>Microsoft Teams<br/>Slack |   |   |
...
| Python versions | 3.10 to 3.13 | 3.10 to 3.13 | GX typically follows the [Python release cycle](https://devguide.python.org/versions/). GX currently supports Python 3.10 to 3.13. Python 3.14 and later are not currently supported.|
