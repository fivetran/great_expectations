...
| Notifications | Email alerts<br/>Email Action<br/>Microsoft Teams Action<br/>Slack Action<br/>Custom Action | Email Action<br/>Microsoft Teams Action<br/>Slack Action<br/>Custom Action | We support the general workflow for creating custom notifications with Actions but cannot help troubleshoot the domain-specific logic within a custom Action. |
