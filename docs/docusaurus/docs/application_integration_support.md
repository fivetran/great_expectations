...
| -------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------- |
| Data Sources<sup>1</sup>         | Databricks (SQL)<br/>PostgreSQL<sup>2</sup><br/>Redshift<br/>Snowflake | BigQuery<br/>Databricks(SQL)<br/>PostgreSQL<sup>2</sup><br/>Pandas<br/>Redshift<br/>Snowflake<br/>Spark<br/>SQLite | MSSQL<br/>MySQL<br/> |
