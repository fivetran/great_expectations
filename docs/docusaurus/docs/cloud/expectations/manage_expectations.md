...
| Numeric            | **column most common value to be in set**            | Expect the most common value to be within the designated value set.                                                                    | No                  |
| Numeric            | **column pair values to be equal**                   | Expect the values in column A to be the same as column B.                                                                              | No                  |
| Numeric            | **column values to be in set**                       | Expect each column value to be in a given set.                                                                                         | No                  |
| Numeric            | **column values to not be in set**                   | Expect column entries to not be in the set.                                                                                            | No                  |
