...
| Validity           | **column value length to be between**                | Expect the column entries to be strings with length between a minimum value and a maximum value.                                       | No                  |
| Validity           | **column value length to equal**                     | Expect the column entries to be strings with length equal to the provided value.                                                       | No                  |
