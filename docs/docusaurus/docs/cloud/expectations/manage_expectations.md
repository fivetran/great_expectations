...
3. Get the Expectation from the Expectation Suite.
   ...
   Expectations can be found within the Expectation Suite using a variety of methods. In the example below, the expectation is found by iterating through all of the Expectations within the Expectation Suite and then matching on the Expectation type and the column name:
