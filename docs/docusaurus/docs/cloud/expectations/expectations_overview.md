...
- Pipeline conditioning with the `get_maximum_severity_failure` helper method in the [`ExpectationSuiteValidationResult` class](/docs/reference/api/core/expectationsuitevalidationresult_class).
