...
| Validation Results    | [Access results in the Validations tab](/cloud/validations/run_validations.md#view-validation-run-history) of the GX Cloud UI.                                                                           | [Access results with the GX Cloud API](/core/trigger_actions_based_on_results/choose_a_result_format/choose_a_result_format.md) or in the Validations tab of the GX Cloud UI.                               |
