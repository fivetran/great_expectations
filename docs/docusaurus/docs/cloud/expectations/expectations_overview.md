...
| Validation Results    | [Access results in the Validations tab](/cloud/validations/run_validations.md#view-validation-run-history) of the GX Cloud UI.<br />[Format results](/cloud/validations/format_results.md?interface=ui) with the GX Cloud UI or the GX Cloud API. | [Access results with the GX Cloud API](/cloud/validations/run_validations.md?interface=api) or in the Validations tab of the GX Cloud UI.<br />[Format results](/cloud/validations/format_results.md) with the GX Cloud API.   |
