...
- Agent-enabled deployments do not support [ExpectAI](/cloud/overview/accelerating_test_coverage.md#expectai-beta). To be able to generate AI-recommended Expectations or generate custom SQL Expectations based on natural language prompts, use a [fully-hosted deployment](/cloud/deploy/deployment_patterns.md).
