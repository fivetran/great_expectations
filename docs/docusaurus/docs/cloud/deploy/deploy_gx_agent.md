...
Agent-enabled deployments do not support [ExpectAI](/cloud/expectations/manage_expectations.md#generate-ai-recommended-expectations-beta). To be able to generate AI-recommended Expectations, use a [fully-hosted deployment](/cloud/deploy/deployment_patterns.md).
