...
Agent-enabled deployments do not support [ExpectAI](/cloud/expectations/accelerating_test_coverage.md#expectai-beta). To be able to generate AI-recommended Expectations or custom SQL, use a [fully-hosted deployment](/cloud/deploy/deployment_patterns.md).
