...
Use [Actions](/cloud/alerts/trigger_actions.md) to create notification patterns based on [failure severity](/cloud/expectations/expectations_overview/#failure-severity).
:::
