...
<LinkCardGrid>
  <LinkCard topIcon label="Responses overview" description="Explore options for responding to results." to="/cloud/alerts/responses_overview" icon="/img/overivew_icon.png" />
