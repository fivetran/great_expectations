...
<LinkCardGrid>
  ...
  <LinkCard topIcon label="Manage incidents" description="Link Expectation failures to Jira issues to tprioritize and track the resolution of data quality problems." to="/cloud/alerts/manage_incidents" icon="/img/checkpoint_icon.svg" />
