...
- A Checkpoint (either an automatically created GX-managed Checkpoint one or a [manually created Checkpoint](/docs/cloud/validations/manage_validations#api-managed-expectations-entire-asset)).
