...
![Example metrics: Active Coverage 58% warning add Expectations, Active Data Assets 100%, volume 100%, schema 75% warning add Expectations, completeness 50% warning add Expectations.](/img/coverage_health.png)
