...
To detect completeness changes, we automatically generate rules for every column to [**expect column values to not be null**](/reference/learn/data_quality_use_cases/missingness.md#expect-column-values-to-not-be-null) and/or [**expect column values to be null**](/reference/learn/data_quality_use_cases/missingness.md#expect-column-values-to-be-null). The Expecatation(s) and parameters for a column depend on the column's initial null percentage.
