...
* **Alerting.** GX Cloud provides the ability to send alerts when validations fail, enabling your organization to remain proactively aware of the health of your Data Assets. See [Responding to alerts](/cloud/alerts/alerts_lp.md) for more detail.
