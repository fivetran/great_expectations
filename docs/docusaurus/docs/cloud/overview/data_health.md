...
![Example metrics: Data Health 79%, Daily distinct Expectations 9167, Active Coverage 87%, Total Data Assets 390. Failed Expectations 125 Critical, 181 Warning, 52 Info, Daily Data Health rollover details include date, Data Health percentage, count of Expectations validated, and count of successful Expectations. Metrics default to overall data from all Data Sources and can be filtered to a specific data quality issue, such as schema, and/or a specific Data Source, Data Asset, or column name.](/img/data_health.png)
