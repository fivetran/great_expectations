...
# <snippet name="docs/docusaurus/docs/cloud/connect/manage_data_sources.py - get cloud context">
import great_expectations as gx

context = gx.get_context(mode="cloud")
# </snippet>

# <snippet name="docs/docusaurus/docs/cloud/connect/manage_data_sources.py - verify context type">
print(type(context).__name__)
# </snippet>

# <snippet name="docs/docusaurus/docs/cloud/connect/manage_data_sources.py - pick source">
