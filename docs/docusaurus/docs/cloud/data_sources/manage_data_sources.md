...
| [Column filter](/docs/cloud/data_assets/manage_data_assets.md#view-data-asset-metrics) on Data Health dashboard                            | <span role="img" aria-label="Yes">✅</span>                                    | <span role="img" aria-label="Yes">✅</span> | <span role="img" aria-label="No">❌ </span>                                   | None                                                                                                                                                                           |
