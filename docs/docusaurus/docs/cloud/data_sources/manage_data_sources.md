...
|--------------------------------------------------------------|-------------------------------------------------------------------------------------------------|-----------|-------------------------------------------------------------------|
| [Create Data Source](/cloud/connect/connect_lp)              | UI / API                                                                                        | API       | API                                                               |
| [Edit Data Source configuration](#edit-data-source-settings) | UI / API                                                                                        | API       | API                                                               |
| [Add Data Assets](/cloud/data_assets/manage_data_assets)     | UI / API                                                                                        | API       | API                                                               |
| [Define Batches](/cloud/validations/run_validations)         | UI / API                                                                                        | API       | API                                                               |
| [Run ad hoc Validations](/cloud/validations/run_validations) | UI / API                                                                                        | UI / API  | API                                                               |
...
|------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------|-------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Data Asset metrics](/cloud/data_assets/manage_data_assets#view-data-asset-metrics)                                                | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="Yes">✅</span> | <span role="img" aria-label="No">❌ </span>                      | None                                                                                                                                                                   |
| [Generate Anomaly Detection](/cloud/overview/accelerating_test_coverage#anomaly-detection) Expectations when adding a Data Asset   | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="No">❌ </span> | <span role="img" aria-label="No">❌ </span>                      |[Manually configure Anomaly Detection](/cloud/expectations/expectations_overview#anomaly-detection) by adding Expectations with Dynamic Parameters or forecasted ranges |
| [Generate Anomaly Detection](/cloud/overview/accelerating_test_coverage#anomaly-detection) Expectations when adding an Expectation | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="Yes">✅</span> | <span role="img" aria-label="No">❌ </span>                      |[Manually configure Anomaly Detection](/cloud/expectations/expectations_overview#anomaly-detection) by adding Expectations with Dynamic Parameters or forecasted ranges |
| [ExpectAI](/cloud/overview/accelerating_test_coverage#expectai-beta)                                                               | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="No">❌ </span> | <span role="img" aria-label="No">❌ </span>                      | None                                                                                                                                                                   |
| [Schedule recurring Validations](/cloud/schedules/manage_schedules)                                                                | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="No">❌ </span> | <span role="img" aria-label="No">❌ </span>                      |[Use an orchestrator](/reference/learn/integrations/data_pipeline_tutorial) to run recurring Validations                                                                |
