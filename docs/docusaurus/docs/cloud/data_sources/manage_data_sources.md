...
| [Run ad hoc Validations](/docs/cloud/validations/run_validations.md) | UI / API                                                                                                                     | UI / API  | UI / API  | API                                                                           |
...
| Feature                                                                                                                                    | Databricks SQL<br/>Microsoft Fabric<br/>Microsoft SQL Server<br/>PostgreSQL and its derivatives *<br/>Redshift<br/>Snowflake | Trino                                       |Amazon S3                                    | Azure Blob Storage<br/>BigQuery<br/>Google Cloud Storage<br/>Pandas<br/>Spark | Workaround for unsupported Data Sources                                                              |
|:-------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------|:--------------------------------------------|:------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
