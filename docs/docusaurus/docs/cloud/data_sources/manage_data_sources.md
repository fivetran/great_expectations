...
| Workflow                                                     | AlloyDB, Amazon Aurora PostgreSQL, Citus, Databricks SQL, Neon, PostgreSQL, Redshift, Snowflake | Amazon S3 | Azure Blob Storage, BigQuery, Google Cloud Storage, Pandas, Spark |
|--------------------------------------------------------------|-------------------------------------------------------------------------------------------------|-----------|-------------------------------------------------------------------|
| [Create Data Source](/cloud/connect/connect_lp.md)              | UI / API                                                                                        | API       | API                                                               |
| [Edit Data Source configuration](#edit-data-source-settings) | UI / API                                                                                        | API       | API                                                               |
| [Add Data Assets](/cloud/data_assets/manage_data_assets.md)     | UI / API                                                                                        | API       | API                                                               |
| [Define Batches](/cloud/validations/run_validations.md)         | UI / API                                                                                        | API       | API                                                               |
| [Run ad hoc Validations](/cloud/validations/run_validations.md) | UI / API                                                                                        | UI / API  | API                                                               |

Some UI-only features are not supported for some Data Sources. Consult the table below for limitations and, where available, workarounds.

| Feature                                                                                                                            | AlloyDB, Amazon Aurora PostgreSQL, Citus, Databricks SQL, Neon, PostgreSQL, Redshift, Snowflake | Amazon S3                                  | Azure Blob Storage, BigQuery, Google Cloud Storage, Pandas, Spark | Workaround for unsupported Data Sources                                                                                                                                |
|------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------|-------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Data Asset metrics](/cloud/data_assets/manage_data_assets.md#view-data-asset-metrics)                                                | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="Yes">✅</span> | <span role="img" aria-label="No">❌ </span>                      | None                                                                                                                                                                   |
| [Generate Anomaly Detection](/cloud/overview/accelerating_test_coverage.md#anomaly-detection) Expectations when adding a Data Asset   | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="No">❌ </span> | <span role="img" aria-label="No">❌ </span>                      |[Manually configure Anomaly Detection](/cloud/expectations/expectations_overview.md#anomaly-detection) by adding Expectations with Dynamic Parameters or forecasted ranges |
| [Generate Anomaly Detection](/cloud/overview/accelerating_test_coverage.md#anomaly-detection) Expectations when adding an Expectation | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="Yes">✅</span> | <span role="img" aria-label="No">❌ </span>                      |[Manually configure Anomaly Detection](/cloud/expectations/expectations_overview.md#anomaly-detection) by adding Expectations with Dynamic Parameters or forecasted ranges |
| [ExpectAI](/cloud/overview/accelerating_test_coverage.md#expectai-beta)                                                               | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="No">❌ </span> | <span role="img" aria-label="No">❌ </span>                      | None                                                                                                                                                                   |
| [Schedule recurring Validations](/cloud/schedules/manage_schedules.md)                                                                | <span role="img" aria-label="Yes">✅</span>                                                     | <span role="img" aria-label="No">❌ </span> | <span role="img" aria-label="No">❌ </span>                      |[Use an orchestrator](/reference/learn/integrations/data_pipeline_tutorial) to run recurring Validations                                                                |
