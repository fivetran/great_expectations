...
| Workflow                                                             | AlloyDB<br/>Amazon Aurora PostgreSQL<br/>Citus<br/>Databricks SQL<br/>Neon<br/>PostgreSQL<br/>Redshift<br/>Snowflake | Amazon S3 | Azure Blob Storage<br/>BigQuery<br/>Google Cloud Storage<br/>Pandas<br/>Spark |
|:---------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|:----------|:------------------------------------------------------------------------------|
...
| Feature                                                                                                                                    | AlloyDB<br/>Amazon Aurora PostgreSQL<br/>Citus<br/>Databricks SQL<br/>Neon<br/>PostgreSQL<br/>Redshift<br/>Snowflake | Amazon S3                                   | Azure Blob Storage<br/>BigQuery<br/>Google Cloud Storage<br/>Pandas<br/>Spark | Workaround for unsupported Data Sources                                                              |
|:-------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|:--------------------------------------------|:------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
