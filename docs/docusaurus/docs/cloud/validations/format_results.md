...
For more information about how the opinionated options in the UI map to the more granular options in the API, see the [UI options reference table](/docs/cloud/validations/format_results?results=ui_options#configure-validation-results).
</TabItem>
