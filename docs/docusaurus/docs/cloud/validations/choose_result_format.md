...
1. Create a dictionary and set the verbosity of returned Validation Results.
   ...
   You can check the [Validation Results reference tables](&results=verbosity#validation-results-reference-tables) to see what information is provided in the `result` dictionary.
