...
<tbody>
  <tr>
    style={{ verticalAlign: 'top' }} rowSpan={5}>GX-managed</td>
    style={{ verticalAlign: 'top' }} rowSpan={2}>Entire&nbsp;Data&nbsp;Asset</td>
  ...
  <tr>
    style={{ verticalAlign: 'top' }} rowSpan={3}>Time-based&nbsp;subset</td>
  ...
  <tr>
    style={{ verticalAlign: 'top' }} rowSpan={3}>API-managed</td>
  ...
  <tr>
    style={{ verticalAlign: 'top' }} rowSpan={2}>Time-based&nbsp;subset   </td>
