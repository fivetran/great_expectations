...
5. Optional. Hover over a success or [failure severity](/cloud/expectations/manage_expectations#failure-severity) icon in the Validation timeline to view details about a specific Validation run, including the observed values.
