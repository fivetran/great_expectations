...
<tbody>
  <tr>
    ...
    <td>Use the UI:<ul><li>Click the **Validate** button.</li></ul><a href="">Jump to workflow</a></td>
  </tr>
  <tr>
    <td>Azure&nbsp;Blob&nbsp;Storage <br />BigQuery<br />Google&nbsp;Cloud&nbsp;Storage </td>
    <td>Use the API:<ul><li>Retrieve your Data Asset’s GX-managed Checkpoint.</li><li>Run the Checkpoint.</li></ul><a href="">Jump to workflow</a></td>
  </tr>
  <tr>
