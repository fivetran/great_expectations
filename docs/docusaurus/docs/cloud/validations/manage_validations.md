...
Note that if your Expectations use the following aspects of [row conditions](/cloud/expectations/expectations_overview.md#row-conditions), your GX library version must be >= 1.8.0.
