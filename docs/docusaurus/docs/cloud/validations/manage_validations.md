...
<tbody>
  ...
  <tr>
    ...
    <td>Use the UI:<br /><br />- Define a batch.<br />- Click the **Validate** button.<br /><a href="">Jump to instructions</a></td>
  </tr>
  <tr>
    <td>S3<br />Azure&nbsp;Blob&nbsp;Storage <br />Google&nbsp;Cloud&nbsp;Storage </td>
    <td>Use the API:<br />- Define a batch based on regex filename matching<br />- Retrieve your Data Asset's GX-managed Checkpoint<br />- Run the Checkpoint with batch parameters<br /><a href="">Jump to instructions</a></td>
  </tr>
  <tr>
    <td>BigQuery</td>
    <td>Use the API:<br />- Define a batch based on values in a DATE or DATETIME column<br />- Retrieve your Data Asset's GX-managed Checkpoint<br />- Run the Checkpoint with batch parameters<br /><a href="">Jump to instructions</a></td>
  </tr>
  <tr>
    <td rowspan="3">API-managed</td>
    <td>Entire&nbsp;Data&nbsp;Asset</td>
    <td>All sources</td>
    <td>Use the API:<br />- Retrieve your Data Asset's GX-managed Batch Definition<br />- Associate it with your API-managed Expectations via a Validation Definition<br />- Run the Validation Definition<br /><a href="">Jump to instructions</a></td>
  </tr>
  <tr>
    ...
    <td>Use the API:<br />- Define a batch based on values in a DATE or DATETIME column<br />- Associate it with your API-managed Expectations via a Validation Definition<br />- Run the Validation Definition with batch parameters<br /><a href="">Jump to instructions</a></td>
  </tr>
  <tr>
    <td>S3<br />Azure&nbsp;Blob&nbsp;Storage <br />Google&nbsp;Cloud&nbsp;Storage </td>
    <td>Use the API:<br />- Define a batch based on regex filename matching<br />- Associate it with your API-managed Expectations via a Validation Definition<br />- Run the Validation Definition with batch parameters<br /><a href="">Jump to instructions</a></td>
  </tr>
</tbody></table>
