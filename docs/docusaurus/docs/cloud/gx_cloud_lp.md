...
<LinkCardGrid>
  ...
  <LinkCard topIcon label="Manage schedules" description="Use a schedule to automate data quality checks." to="/cloud/alerts/manage_alerts" icon="/img/small_gx_logo.png" />
