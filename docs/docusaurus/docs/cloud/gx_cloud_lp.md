...
<LinkCardGrid>
  ...
  <LinkCard topIcon label="Manage access" description="Manage GX Cloud workspaces, users, and access tokens." to="/cloud/users/manage_users" icon="/img/small_gx_logo.png" />
</LinkCardGrid>