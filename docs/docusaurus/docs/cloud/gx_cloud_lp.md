...
<LinkCardGrid>
  <LinkCard topIcon label="Manage Data Sources" description="Manage data connections in GX Cloud." to="/cloud/data_assets/manage_data_assets" icon="/img/small_gx_logo.png" />
