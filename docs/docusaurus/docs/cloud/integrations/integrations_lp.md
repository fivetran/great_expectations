...
<LinkCardGrid>
  ...
  <LinkCard topIcon label="Jira" description="Enable incident management that links Expectation failures to Jira issues." to="/cloud/integrations/integrate_jira" icon="/img/jira_icon.png"/>
