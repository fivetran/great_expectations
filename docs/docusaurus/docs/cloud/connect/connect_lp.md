...
<LinkCardGrid>
  ...
  <LinkCard topIcon label="Connect GX Cloud to Snowflake" description="Start using GX Cloud with Trino." to="/cloud/connect/connect_trino" icon="/img/trino_icon.png" />
